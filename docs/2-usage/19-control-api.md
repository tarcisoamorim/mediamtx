...
The control API is documented in the [Control API Reference page](/docs/references/control-api) and in the [OpenAPI / Swagger file](https://github.com/tarcisoamorim/peep-mediaserver/blob/{version_tag}/api/openapi.yaml).
